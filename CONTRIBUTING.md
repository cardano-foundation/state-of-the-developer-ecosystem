...
Every edition is stored in a dedicated folder (e.g. `2025`) and have specific instructions when it comes to building. Feel free to read the instructions if the keyboard is itching and feel like contributing to the source.
